...
/* formula 1 */
strategy Deterrence1000 = minE (aov/100 + number_deaths*1000 ) [<=120] {p} -> {t, v}: <> elapsed >= 120
...
/* formula 6 */
strategy Deterrence100 = minE (aov/100 + number_deaths*100 ) [<=120] {p} -> {t, v}: <> elapsed >= 120
...
/* formula 11 */
strategy Deterrence10 = minE (aov/100 + number_deaths*10 ) [<=120] {p} -> {t, v}: <> elapsed >= 120
...
/* formula 16 */
strategy Deterrence0 = minE (aov/100 + number_deaths*0 ) [<=120] {p} -> {t, v}: <> elapsed >= 120
