README for UPPAAL Stratego 5.0.0-rc2, March 2023 
...
To install, unzip the zip-file uppaal-5.0.0-rc2. This should create
the directory uppaal-5.0.0-rc2 containing at least the files uppaal,
...
MacOS:
* Remove quarantine attribute: `xattr -r -d com.apple.quarantine uppaal-5.0.0-rc2`
* Launch uppaal script, or run `java -jar uppaal.jar` on command line
* Move the UPPAAL-5.0.0-rc2.app to Applications and launch it from there.
